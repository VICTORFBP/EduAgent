...
- Completar espacios en tabla (columnas con celdas vacías)
- Procedimiento paso a paso con `[LINEAS:5]` o `[LINEAS:8]`
- Falso / Verdadero con tabla `| Afirmación | V | F |`
- Problema contextualizado colombiano con espacio de desarrollo
